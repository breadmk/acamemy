...
public class String02 {
	...
	public static void main(String[] args) {
		String str = "안녕하세요";
//		byte[] 변수명 = "문자열".getBytes()
		byte[] bytes1 = str.getBytes();
		System.out.println("bytes1.length="+bytes1.length);//15
		
		String str1 = new String(bytes1);
		System.out.println("bytes1 -> String으로 변환 str1 = "+str1);//안녕하세요
...
//			EUC-KR을 통해서 인코딩 
			...
			System.out.println("bytes2.length="+bytes2.length);//15
//			EUC-KR을 이용해서 디코딩
			String str2 = new String(bytes2,"EUC-KR");//
			System.out.println("bytes2 -> String으로 변환 str2 = "+str2);
...
//			UTF-8을 이용해서 디코딩
			...
			System.out.println("bytes3 -> String으로 변환 str3 = "+str3);
