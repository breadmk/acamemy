 ...
 * 그 안에서 추가, 수정, 삭제 작업을 할 수 있도록 설계되어있다.
...
//		setCharAt(자리,값)그 자리에 있는 숫자를 교체.
		sb.setCharAt(4,'6');
		...
		if( sb instanceof StringBuilder) {
			System.out.println("StringBuilder의 instance 이다.");
		}
		//객체비교
		System.out.println((sb == sb.append("하나")));
		System.out.println((sb.append("하나")==sb.append("하나").append("둘")));
		System.out.println();
		...
		//StringBuilder를 String으로 변환.
		 ...
		 System.out.println(str == (str+"하나"));	//문자열 false
		 System.out.println((str+"하나") == (str+"하나+둘"));	//문자열 false
	}
