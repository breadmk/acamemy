...
// 실행에러의 대표적인 실행에러 : ArrayIndexOutOfBoundsException 
public class ArrayIndexOutOfBoundsException01 {
// run configurations에서 arguments 로 넣어도됨.
...
//		at ch08.ArrayIndexOutOfBoundsException01.main(ArrayIndexOutOfBoundsException01.java:9)
		...
		System.out.println("args[1] = "+data1);
			...
			System.out.println("데이터를 2개 이상 입력해주세요");
		}
	}
