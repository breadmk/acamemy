...
/*	에러(error) " 컴퓨터 H/W의 오동작, 고장으로 인해 응용P/G 실행오류가 발생하는것
 ...
 *  예외의 종류.
 *  -일반예외(Exception)	: 컴파일 예외, 컴파일하는 과정에서 예외처리코드가 필요한지 검사
...
// 즉 null값을 갖는 참조변수로 객체접근자 연산자인  . 을 사용했을 때 발생한다.
// 해결방법? 주소를 주자.
...
//		at ch08.Exception01.main(Exception01.java:21)
